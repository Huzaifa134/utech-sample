  ...
  return (
    <header id="header" className="d-none d-xl-block ">
      <div className="top-bar">
        <div className="inner jus-ct" style={{background:"#007aff"}} >
          <p className="clr-pri-1">
            Working Jours : Sun - Friday, 08:00 am - 07:00 pm
          </p>
        </div>
      </div>
      <div id="site-header" className=""  style={{background:"#00a3e8"}}>
                ...
                <div className="header-right fx">
                  ...
                  <div className="header-contact fx">
                    ...
                    <div className="inner-contact fx">
                      ...
                      <ul >
                        <li className="clr-pri-2 text-white">Hotline</li>
                        <li className="clr-pri-2 text-white">+012 (345) 678</li>
                      </ul>
                    </div>
                  </div>
                </div>
