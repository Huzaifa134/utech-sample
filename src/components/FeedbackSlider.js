...
const FeedbackSlider = ({feedbackDetails}) => {
  return (
    <Swiper
      {...testimonialSlider}
      loop={false}
      ...
      <SwiperSlide key={feedback.sys.id}>
        <div className="item-quote" data-dot="">
          <div className="heading">
            <div className="left fx">
              <div className="box-avt">
                ...
                <Image src={'https:' + feedback.fields.image.fields.file.url} alt="" height={71} width={91}/>
              </div>
              <ul>
                <li>
                  <h4 className="name-author clr-pri-2">{feedback.fields.name}</h4>
                </li>
                <li>
                  <p className="clr-pri-5 f-mulish">{feedback.fields.designation}</p>
                </li>
              </ul>
            </div>
            <div className="right">
          ...
          <div className="wrap">
            ...
            <span>&quot;</span>{feedback.fields.details}<span>&quot;</span>
            </p>
          </div>
        </div>
      </SwiperSlide>
