...
const TfCounter = ({ nonst,counter }) => {
  // console.log("counter values" , counter)
  // console.log("counter values" , counter[0].fields.entry1)
  return (
            ...
            >
              ...
              <div className="box-content box">
                <div className="number-content clr-pri-1">
                  <Counter end={counter[0].fields.entry1} />+
                </div>
                <p className="clr-pri-1">{counter?counter[0].fields.entry1Subtxt:"dummy"}</p>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-lg-3 col-md-3 col-12">
            ...
            >
              ...
              <div className="box-content box">
                <div className="number-content clr-pri-1">
                  <Counter end={counter[0].fields.entry2} />+
                </div>
                <p className="clr-pri-1">{counter?counter[0].fields.entry2Subtxt:"dummy-content"}</p>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-lg-3 col-md-3 col-12">
            ...
            >
              ...
              <div className="box-content box">
                <div className="number-content clr-pri-1">
                  <Counter end={counter[0].fields.entry3} />+
                </div>
                <p className="clr-pri-1">{counter?counter[0].fields.entry3Subtxt:"dummay-content"}</p>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-lg-3 col-md-3 col-12">
            ...
            >
              ...
              <div className="box-content box">
                <div className="number-content clr-pri-1">
                  <Counter end={counter[0].fields.entry4} />+
                </div>
                <p className="clr-pri-1">{counter?counter[0].fields.entry4Subtxt:"dummay-content"}</p>
              </div>
            </div>
          </div>
        </div>
